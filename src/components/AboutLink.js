...
import WhitePaperPDF from '../../src/AgriVerse_WhitePaper.pdf';
import Audit from '../../src/Agriverse_KYCCertificate_InterFi.pdf'
// import Video from '../images/tree.mp4'
import AOS from 'aos';
  ...
  return (
    <>
      ...
      <div className="aboutlink">
        ...
        <div className="alink">
          <div className="about--us"  data-aos="fade-up" data-aos-duration='2000' >
            ...
            The mode of play is a new concept in the world of gaming and one that gamers can leverage on in order to maximize profit.
            

          </div>
          <div className="about--us--text" >
            {/* <span className="check"> */}
            <button type="button" id="i1" className="about--us--btn " data-bs-toggle="modal" data-bs-target="#exampleModal">
              About Us
            </button>
            <Link to={WhitePaperPDF} target="_blank" style={{ textDecoration: "none" }}>
              <button type="button" className="about--us--btn" id="i2">
                WhitePaper
              </button>
            </Link>
            <Link to={Audit} target="_blank"   style={{ textDecoration: "none" }}>
              <button type="button" className="about--us--btn" id="i3">
                Audit & KYC Report
              </button>
            </Link>
            {/* </span> */}
