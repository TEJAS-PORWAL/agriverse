  ...
  return (
    <div className="faq--cont">
      <div className="container" >
       <div className="underline"> <h1 className="faq--heading" data-aos='fade-up' data-aos-duration='450' >FAQ</h1></div>
        <div className="accordion accordion-flush" id="accordionFlushExample" >
          <div className="accordion-item" data-aos='fade' data-aos-duration='450'  data-aos-delay='200'>
          ...
          <div className="accordion-item" data-aos='fade' data-aos-duration='450' data-aos-mirror='true' data-aos-delay='300'>
          ...
          <div className="accordion-item" data-aos='fade' data-aos-duration='450' data-aos-mirror='true' data-aos-delay='400'>
          ...
          <div className="accordion-item" data-aos='fade' data-aos-duration='450' data-aos-mirror='true' data-aos-delay='500'>
