...
export default function Footer() {
  ...
  const contactUsLinks = [
    ...
    },
    {
        ...
        // link: "http://theagriverse.com/team"
    }
]
  ...
  return (
    <footer >
      <div className="top" method= "POST" data-aos='fade-up' data-aos-duration='900'>
        <form>
      ...
      <div className="mid" data-aos='fade-down' data-aos-duration='900'>
        ...
        <div className="mid--right" data-aos='fade-up' data-aos-duration='500' >
          <h2 className="right--title">Join our community</h2>
          <div className="mid--right--links">
            <a target="_blank" rel="noreferrer" href={fblink} className="fb">
              <i className="fab fa-facebook-f"></i>
            </a>
            <a target="_blank" rel="noreferrer" href={instlink} className="insta">
              <i className="fab fa-instagram"></i>
            </a>
            <a target="_blank" rel="noreferrer" href={Linkedlink} className="linkedIn">
              <i className="fab fa-linkedin-in"></i>
            </a>
            <a target="_blank" rel="noreferrer" href={twtlink} className="twitter">
              <i className="fab fa-twitter"></i>
            </a>
            <a target="_blank" rel="noreferrer" href={Redditlink} className="reddit">
              <i className="fab fa-reddit-alien"></i>
            </a>
            <a target="_blank" rel="noreferrer" href={tellink} className="telegram">
              <i className="fab fa-telegram"></i>
            </a>
            <a target="_blank" rel="noreferrer" href={medlink} className="medium">
              <i className="fab fa-medium-m"></i>
            </a>
            {/* <a target="_blank" rel="noreferrer" href={gitlink}>
              <i className="fab fa-github-alt"></i>
            </a> */}
            <a target="_blank" rel="noreferrer" href={yTubelink} className="youtube">
