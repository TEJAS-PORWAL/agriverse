    ...
    return (<footer>
        ...
        <div className='mid--left'>
            <form className='mid--form'>
                ...
                <input type='text' className='form--name' id='name' name='name' autoComplete='off' placeholder='Full Name' />
                {/* <label className='form--label' for='mail' >Email Address</label> */}

                <input className='form--email' type='email' id='mail' name='email' autoComplete='off' placeholder='Email Address' />
                <textarea placeholder='Your Message' name='message' autoComplete='off' className='form--textarea' rows="5"></textarea>
                <input className='form--mobile' type='number' id='number' name='mobile number' autoComplete='off' maxLength={10} optional
        ...
        <div className='mid--right'>
            ...
            <div className='mid--right--links'>
                <p className="combine"><a target="_blank" rel='noreferrer' href={fblink}><i className='fab fa-facebook-f'></i></a>
            ...
            <p className="combine2"><div className='mid--right--email'>
